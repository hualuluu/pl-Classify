...
def seresnet(model_name, class_num, pretrained=False):
    model_dict = {
        'seresnet_18':se_resnet18(class_num),
        'seresnet_34':se_resnet34(class_num),
        'sepreactresnet_20':se_preactresnet20(num_classes = class_num),
        'sepreactresnet_32':se_preactresnet32(num_classes = class_num)
    } 
